...
<div class="block_zero center blue">Золото - самый ценный ресурс!</div>
<div class="mini-line"></div>
<div class="block_zero center"><img src="/images/town/hd/trade.jpg" alt="" width="100%"></div>
<div class="mini-line"></div>
<div class="menuList"><li><a href="/trade/exchange/"><img src="/images/icon/gold.png" alt="">Обменник золота</a></li>
<div class='content' align='center'>Купить золото</div>
</div>
<div class='line'></div>
...
{
echo " <div class='index_menu'>  <a href='/paywk/?gold=$key' style='display: block;'> Купить $key золота $value руб. </div></a>";
}
